...
namespace NewWcfGlobalService
{
    ...
    // NOTE: In order to launch WCF Test Client for testing this service, please select SmsService.svc or SmsService.svc.cs at the Solution Explorer and start debugging.
